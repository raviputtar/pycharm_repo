...
def check_winner(p1_cards,p1_suits,p2_cards,p2_suits):
    ...
    p1_hand_score=myhand_score.copy()
    print("p1 hand score-->",p1_hand_score)
    p2_score=get_score(p2_cards,p2_suits)
    print("p2_Score-->", p2_score)
    p2_hand_score=myhand_score.copy()
    print("p2 hand score-->", p2_hand_score)
    for i in range(1,11):
        if p1_score[i]> p2_score[i]:
            ...
            print("i now is",i)
            if i in p1_hand_score and i in p2_hand_score:
                print("i in both")
                print ("p1_handscore",p1_hand_score)
                print("p2_handscore",p2_hand_score)
                if p1_hand_score[i] > p2_hand_score[i]:
                    wincount += 1
                    print("p1 is winner by greater hand")
                    break
                elif p1_hand_score[i] < p2_hand_score[i]:
                    print("p2 is winner by greater hand")
                    break
                else:
                    pass

            elif i in p1_hand_score and i not in p2_hand_score:
                wincount += 1
                print("p1 is winner by greater hand")
                break
            elif i not in p1_hand_score and i in p2_hand_score:
                print("p2 is winner by greater hand")
                break
            elif i not in p1_hand_score and i not in p2_hand_score:
                pass
        else:
            print("p2 is winner by greater",i,"to p1's")
            break
